...
public class objectDetectorClass {
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        // Fix crashing problems of the app
        ...
        // defining output
        // 5: top 5 object detected
        // 3: there coordinate in image
      //  float[][][]result=new float[1][10][3];
        ...
        for (int i=0;i<5;i++){
            ...
            if(score_value>0.5){
                ...
                Imgproc.rectangle(rotated_mat_image,new Point(left,top),new Point(right,bottom),new Scalar(0, 255, 0, 255),4);
                // write text on frame
                                                // string of class name of object  // starting point                         // color of text           // size of text
                Imgproc.putText(rotated_mat_image,labelList.get((int) class_value),new Point(left,top),3,1,new Scalar(255, 0, 0, 255),5);
            }
    ...
    private ByteBuffer convertBitmapToByteBuffer(Bitmap bitmap) {
        ...
        // for this quant=0
        // use quant=1 as we are scaling images from 0-255 to 0-1
        int quant=1;
